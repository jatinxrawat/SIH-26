...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#FBFBFA] text-[#0F172A] selection:bg-emerald-100 selection:text-emerald-900 font-sans overflow-x-hidden w-full max-w-full relative">
