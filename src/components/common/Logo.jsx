...
export function LogoMark({ className = 'w-10 h-10', variant = 'dark', iconClassName = '' }) {
  ...
  const emeraldGradId = `udyam-em-${id}`;
  const saffronGradId = `saathi-saf-${id}`;
  const starGradId = `saathi-star-${id}`;
  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id={emeraldGradId} x1="6" y1="36" x2="34" y2="12" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id={saffronGradId} x1="20" y1="26" x2="38" y2="8" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id={starGradId} x1="18" y1="6" x2="26" y2="22" gradientUnits="userSpaceOnUse">
  ...
  return (
    <div className={`flex items-center gap-2.5 sm:gap-3 group select-none ${className}`}>
      ...
      <div className="flex flex-col text-left">
        ...
        {showTagline && (
          <span
            className={`text-[9px] sm:text-[9.5px] uppercase font-bold tracking-wider mt-0.5 leading-none hidden xs:block ${
